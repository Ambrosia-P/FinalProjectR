...
# Prepare panel dataset (using existing data structure)
...
# Panel regression with country fixed effects and interaction term
...
# Group countries by gas dependence
panel_data <- panel_data |> 
  mutate(gas_category = ifelse(`gas share` >= median(`gas share`, na.rm = TRUE), 
                                "High Gas Dependence", 
                                "Low Gas Dependence"))

# Calculate average prices by gas category and year
