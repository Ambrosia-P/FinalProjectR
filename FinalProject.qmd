...
```
This graphical representation cast light on the heterogeneity of the national electricity generation structure before the crisis. However, we would like to deepen our analysis by studying the gas dependency and the use of the 
...
Following this graphical representation, we want to suggest a classification of the countries according to their pre-crisis energy mix structure. 
This typology split the countries in 4 groups :
